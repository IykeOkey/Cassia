...
<div class="container-fluid" style="max-width: 785px;">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h2 class="text-center">Types of Leave Form</h2>
            
            <form action="{{ route('leaves.store') }}" method="POST">
                @csrf
                <div class="row" style="margin-bottom: 1em;">
                    <div class="col">
                        <input type="text" name="lv_code" class="form-control" placeholder="Leave Code">
                    </div>
                    <div class="col">
                        <input type="text" name="lv_name" class="form-control" placeholder="Leave Name">
                    </div>
                </div>
