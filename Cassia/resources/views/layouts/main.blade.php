    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                ...
                <div class="sidebar-brand-text mx-3">{{ config('app.name') }} <sup>v1</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('employee') }}">Employee List</a>
                        <a class="collapse-item" href="{{ url('employee/create') }}">Add New Staff</a>
                        <a class="collapse-item" href="{{ url('employedit') }}">Edit Staff</a>
                        <a class="collapse-item" href="{{ url('employprint') }}">Print Data</a>
                    </div>
                </div>
            </li>
...
<!--Edit Modal end -->
    ...
    <script>
        function fetchData(value) {
            ...
            // Send the value to a Laravel route that will query the MySQL table

            // Example using jQuery AJAX
            $.ajax({
                url: '/fetch-data/' + value, // Replace with your Laravel route URL
                type: 'GET',
                success: function(response) {
                // Process the response from the server-side route
                populateSecondSelection(response);
                },
                error: function() {
        ...
        function populateSecondSelection(response) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                option.text = data[i].bk_name; // Assuming 'name' is a field in your MySQL table
                option.value = data[i].id; // Assuming 'id' is a field in your MySQL table
